...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ImagesFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\CategoriesFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\ImagesFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\ProductsFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\UsersFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')), $b), 'groups' => []]]);

...
class __TwigTemplate_d4bff05676a599412d005ce5599dfce6 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["products"]) {
            // line 9
            echo "\t\t";
            $this->loadTemplate("products/_products.html.twig", "products/index.html.twig", 9)->display($context);
            // line 10
            echo "\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  126 => 11,  112 => 10,  109 => 9,  92 => 8,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t{% include \"products/_products.html.twig\" %}
\t{% endfor %}

...
class __TwigTemplate_db14681d94210a3ec2ecd427a06571eb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<p>";
        // line 38
        echo twig_escape_filter($this->env, twig_striptags(twig_nl2br(twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 38, $this->source); })()), "description", [], "any", false, false, false, 38))), "html", null, true);
        echo "</p>
\t\t\t\t<p>Catégorie :
\t\t\t\t\t";
        // line 40
